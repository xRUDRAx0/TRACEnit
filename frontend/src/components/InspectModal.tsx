    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-2xl bg-background border border-border rounded-lg shadow-lg overflow-hidden flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                {event.sessionNumber && (
                  <span className="text-[10px] bg-surface border border-border px-1.5 py-0.5 rounded-sm text-text-secondary">
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-6">
          ...
          {/* Session Context */}
          <div className="flex items-center justify-between p-4 bg-surface-secondary/50 border border-border rounded-md">
            <div>
          ...
          <div className="bg-surface-secondary rounded-md p-4 border border-border">
            ...
            {event.elementType && event.elementType !== "Unknown Type" && (
              <span className="inline-block mt-2 px-2 py-1 rounded-sm bg-background text-[10px] font-mono text-text-secondary border border-border">
          ...
          {event.metadata && (
            <div className="space-y-4">
              ...
              {event.metadata.clipboardData && (
                <div className="bg-surface-secondary/50 border border-accent/20 rounded-md p-4 relative group">
